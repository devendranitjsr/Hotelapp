        ...
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <form className='flex flex-col md:flex-row items-start md:items-center
             justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
                ...
                <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                    ...
                    <div className='flex flex-col'>
                        <label htmlFor="chackInDate" className='font-medium'>Check-In</label>
                        <input type="date" id='chackInDate' placeholder="Check-In" 
                    ...
                    <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
                      ...
                      <div className='flex flex-col'>
                        <label htmlFor="chackOutDate" className='font-medium'>Check-Out</label>
                        <input type="date" id='chackOutDate' placeholder="Check-Out" 
                        className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none ' required/>
                    </div>
            ...
            <div>
                <p className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                    Guests will be allocated on the ground floor according to avsilability.
                    you get a comfortable two bedroom apartment has a true city feeling. The price quoted is for two guest, at the guest 
                    slot please mark the number of guests to get the exact price for groups. The Guests will be allocated ground floor according
                    to availability. You get the comfortable two bedroom apartment that has a true city feeling.
                </p>
            </div>
