...
const AddRoom  = () => {
    ...
    const onSubmitHandler = async (e)=>{
        ...
        if(!inputs.roomType || !inputs.pricePerNight || !inputs.amenities || 
            ...
            try{
                ...
                // Convrertindg Amenities to Array & keeping only enable Amenities
    ...
    return(
        <form onSubmit={onSubmitHandler}>
            <Title align='left' font='outfit' title='Add Room' subTitle='Fill in the details carefully and accurate room details, pricing, and amenities, to
            ...
            <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                ...
                <div>
                    ...
                    <input type="number" placeholder="0" className='border border-gray-300 mt-1 roundedd p-2 w-24'
