...
const Dashboard  = () => {
    ...
    return(
        <div>
            <Title align='left' font='outfit' title='Dashboard' subTitle='Moniter your room listing, track bookings and analyze revenue-all in one place.
            ...
            <div className='flex gap-4 my-8'>
                ...
                <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
                   ...
                   <div className='flex flex-col sm:ml-4 font-medium'>
                       <p className='text-blue-500 text-lg'>Totel Booking</p>
                ...
                <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
                  ...
                  {/* ----------------------------------------------------TOTAL REVENVE-ICON CHANGE------------------------------------------------------------------------------------------------ */}
                   <img src={assets.totalRevenueIcon} alt="" className='max-sm:hidden h-10' /> 

                   <div className='flex flex-col sm:ml-4 font-medium'>
                       <p className='text-blue-500 text-lg'>Totel Revenue</p>
