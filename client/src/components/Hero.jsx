...
const Hero = () => {
    ...
    const onSearch = async(e) =>{
        ...
        // call api to save recent searchd city

        await axios.post('api/user/store-recent-search', {recentSearchedCity: destination},
            {headers:{ Authorization: `Bearer ${await getToken()}` }});

            // add destination to serachedcities max 3 recent searched cities
    ...
    return (
        ...
        md:px-16 lg:px-24 cxl:px:32 text-white bg-[url("/src/assets/heroImage7.png")] 
        bg-no-reapeat bg-cover bg-center h-screen'>

            <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20'>The Ultimate Hotel Experience</p>

            <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>
                Discover Your Perfact Getway Destination</h1>
